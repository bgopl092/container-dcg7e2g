...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dcg7e2g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dcg7e2g.containers.anotherwebservice.com/
...
```
git clone git@github.com:bgopl092/container-dcg7e2g.git
cd container-dcg7e2g
```
...
```
docker attach container-dcg7e2g
```
